                    ...
                    <div className="container">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <h1 className="text-heading-1 font-bold leading-tight mb-6">
                                Technical <span className="text-red">Team</span>
                            </h1>
                            <p className="text-body-large text-white/80 leading-relaxed">
                                Join our technical team and help us build amazing digital experiences,
                                manage our website, and create innovative solutions for our events.
                            </p>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        {[
                                            'Develop and maintain our website and digital platforms',
                                            'Create interactive experiences for our events',
                                            'Manage technical infrastructure and systems',
                                            'Collaborate with other teams on technical solutions',
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        {[
                                            'Strong programming skills (JavaScript, Python, or similar)',
                    ...
                    <div className="container">
                        <div className="max-w-2xl mx-auto">
                            <h2 className="text-heading-2 font-bold text-center mb-12">
                                Apply for <span className="text-red">Technical Team</span>
                            </h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-white font-semibold mb-2">Technical Experience *</label>
                                        <select
                                            name="experience"
                                ...
                                <div>
                                    <label className="block text-white font-semibold mb-2">Technical Skills *</label>
                                    <textarea
                                        name="skills"
                                ...
                                <div>
                                    <label className="block text-white font-semibold mb-2">Why do you want to join the Technical Team? *</label>
                                    <textarea
                                        name="motivation"
